...
def write_midi(filepath, pianorolls, program_nums=None, is_drums=None,
               track_names=None, velocity=100, tempo=140.0, beat_resolution=24):
...
if __name__ == '__main__':
    ...
    """fp = "C:/Users/salva/Desktop/Audio-to-midi/b.wav"
    mp = './model/model_'+melody_type
    op = "C:/Users/salva/Desktop/alo/b"
    main(fp, mp, op)"""

def generarMelodia(fp):
    name = fp.split('/')[-1].split('.')[0]
    mp = './backendPython/GeneracionDePartitura/model/model_vocal'
    op = "./backendPython/GeneracionDePartitura/Generados/"+name
    main(fp, mp, op)
    return name
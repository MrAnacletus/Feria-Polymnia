...
def izquierda_piano(midi_path, output, nota_corte):
    """Obtiene la mano izquierda de un archivo midi de piano y la guarda en output

    Args:
        midi_path (string): Ruta del archivo midi
        output (string): Ruta donde se guardara el archivo midi de la mano izquierda del piano
        nota_corte (int): Nota que se considera como corte, se recomienda 60
    """   
